...
const SCRIPT_PATH = path.resolve('d:/myfolder/動画生成/ふぁくとラボ/台本作成/記憶は「思い出す」たびに変わるという衝撃/script.md');
const PROJECT_DIR = path.resolve('d:/myfolder/動画生成/ふぁくとラボ/main content/presentation/memory_reconsolidation');
