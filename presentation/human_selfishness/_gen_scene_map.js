...
const SCRIPT_PATH = path.resolve('d:/myfolder/動画生成/台本作成/人間は本来「利己的」なのか？/script.md');
const PROJECT_DIR = path.resolve('d:/myfolder/動画生成/main content/presentation/human_selfishness');
...
const sceneIdRegex = /id="scene-\d+"/g;
const htmlSceneCount = (html.match(sceneIdRegex) || []).length;
