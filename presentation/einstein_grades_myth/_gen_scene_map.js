...
const SCRIPT_PATH = path.resolve('d:/myfolder/動画生成/ふぁくとラボ/台本作成/アインシュタインは学校の成績が悪かったは嘘/script.md');
const PROJECT_DIR = path.resolve('d:/myfolder/動画生成/ふぁくとラボ/main content/presentation/einstein_grades_myth');
