...
export const VideoWithSubtitles: React.FC = () => {
    ...
    const headerTitle = currentEntry?.sceneTitle ?? '1万時間の法則の真実';
    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        width: 50,
                        height: 3,
                        background: 'linear-gradient(90deg, rgba(42,166,160,0.6), rgba(96,165,250,0.4))',
                        borderRadius: 2,
                        marginTop: 2,
                    }} />
                </div>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            height: '100%',
                            background: 'linear-gradient(90deg, #2AA6A0, #60A5FA)',
                            borderRadius: 3,
                        }} />
                    </div>
                </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div style={{
                                            ...
                                            borderRadius: '50%',
                                            backgroundColor: isCurrent ? '#2AA6A0' : 'rgba(107,114,128,0.3)',
                                            boxShadow: isCurrent ? '0 0 8px rgba(42,166,160,0.5)' : 'none',
                                            flexShrink: 0,
                                        }} />
                                        <span style={{
                                            fontSize: isCurrent ? 15 : 13,
                                            fontWeight: isCurrent ? 800 : 500,
                                            color: isCurrent ? '#1E8C86' : '#6B7280',
                                            fontFamily: '"Zen Maru Gothic", sans-serif',
                                            lineHeight: 1.3,
                                            whiteSpace: 'nowrap',
                                            overflow: 'hidden',
                ...
                {currentSpeaker && (
                    <div style={{
                        ...
                        <div style={{
                            ...
                            height: 8,
                            borderRadius: '50%',
                            backgroundColor: currentEntry?.speakerColor ?? '#2AA6A0',
                            boxShadow: `0 0 8px ${currentEntry?.speakerColor ?? '#2AA6A0'}`,
                        }} />
                        <span style={{
                            fontSize: 15,
                            fontWeight: 800,
            ...
            >
                <OffthreadVideo
                    src={staticFile('videos/10000h_rule.mp4')}
                    pauseWhenBuffering
                    toneMapped={false}
                    style={{
                        width: '100%',
