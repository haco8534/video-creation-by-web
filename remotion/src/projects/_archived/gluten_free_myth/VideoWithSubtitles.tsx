...
export const VideoWithSubtitles: React.FC = () => {
    ...
    const headerTitle = currentEntry?.sceneTitle ?? '「グルテンフリー」は健康な人には意味がない';
    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        「グルテンフリー」は健康な人には意味がない
                    </div>
                    <div style={{
                        width: 50,
                        height: 3,
                        background: 'linear-gradient(90deg, rgba(79,70,229,0.6), rgba(99,102,241,0.4))',
                        borderRadius: 2,
                        marginTop: 2,
                    }} />
                </div>
            ...
            >
                <OffthreadVideo
                    src={staticFile('videos/gluten_free_myth.mp4')}
                    style={{
                        width: '100%',
                        height: '100%',
                        objectFit: 'cover',
