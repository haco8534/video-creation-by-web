...
export const VideoWithSubtitles: React.FC = () => {
    ...
    const headerTitle = currentEntry?.sceneTitle ?? '「アインシュタインは学校の成績が悪かった」は嘘';
    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        width: 50,
                        height: 3,
                        background: 'linear-gradient(90deg, rgba(0,119,204,0.6), rgba(0,168,168,0.4))',
                        borderRadius: 2,
                        marginTop: 2,
                    }} />
                </div>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            height: '100%',
                            background: 'linear-gradient(90deg, #0077cc, #00a8a8)',
                            borderRadius: 3,
                        }} />
                    </div>
                </div>
                                ...
                                return (
                                    ...
                                    >
                                        <div style={{
                                            ...
                                            borderRadius: '50%',
                                            backgroundColor: isCurrent ? '#0077cc' : 'rgba(107,114,128,0.3)',
                                            boxShadow: isCurrent ? '0 0 8px rgba(0,119,204,0.5)' : 'none',
                                            flexShrink: 0,
                                        }} />
                                        <span style={{
                                            fontSize: isCurrent ? 15 : 13,
                                            fontWeight: isCurrent ? 800 : 500,
                                            color: isCurrent ? '#004d8c' : '#6B7280',
                                            fontFamily: '"Zen Maru Gothic", sans-serif',
                                            lineHeight: 1.3,
                                            whiteSpace: 'nowrap',
                                            overflow: 'hidden',
                ...
                {currentSpeaker && (
                    <div style={{
                        ...
                        <div style={{
                            ...
                            height: 8,
                            borderRadius: '50%',
                            backgroundColor: currentEntry?.speakerColor ?? '#0077cc',
                            boxShadow: `0 0 8px ${currentEntry?.speakerColor ?? '#0077cc'}`,
                        }} />
                        <span style={{
                            fontSize: 15,
                            fontWeight: 800,
            ...
            >
                <OffthreadVideo
                    src={staticFile('videos/einstein_grades_myth.mp4')}
                    style={{
                        width: '100%',
                        height: '100%',
                        objectFit: 'cover',
