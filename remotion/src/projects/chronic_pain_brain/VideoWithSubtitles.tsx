...
export const VideoWithSubtitles: React.FC = () => {
    ...
    const headerTitle = currentEntry?.sceneTitle ?? '痛みは脳が「作る」──慢性痛の驚くべき正体';
    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        width: 50,
                        height: 3,
                        background: 'linear-gradient(90deg, rgba(79,70,229,0.6), rgba(239,68,68,0.4))',
                        borderRadius: 2,
                        marginTop: 2,
                    }} />
                </div>
            ...
            >
                <OffthreadVideo
                    src={staticFile('videos/chronic_pain_brain.mp4')}
                    style={{
                        width: '100%',
                        height: '100%',
                        objectFit: 'cover',
