...
export const VideoWithSubtitles: React.FC = () => {
    ...
    const headerTitle = currentEntry?.sceneTitle ?? '「デトックス」に科学的根拠はない';
    ...
    return (
        <AbsoluteFill>
                                ...
                                return (
                                    ...
                                    >
                                        <div style={{
                                            ...
                                            borderRadius: '50%',
                                            backgroundColor: isCurrent ? '#10b981' : 'rgba(107,114,128,0.3)',
                ...
                {currentSpeaker && (
                    <div style={{
                        ...
                        <div style={{
                            ...
                            height: 8,
                            borderRadius: '50%',
                            backgroundColor: currentEntry?.speakerColor ?? '#10b981',
                            boxShadow: `0 0 8px ${currentEntry?.speakerColor ?? '#10b981'}`,
                        }} />
                        <span style={{
                            fontSize: 15,
                            fontWeight: 800,
            ...
            >
                <OffthreadVideo
                    src={staticFile('videos/detox_no_evidence.mp4')}
                    style={{
                        width: '100%',
                        height: '100%',
                        objectFit: 'cover',
