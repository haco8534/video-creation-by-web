...
export const VideoWithSubtitles: React.FC = () => {
    ...
    const headerTitle = currentEntry?.sceneTitle ?? 'ドーパミンは「快楽」じゃなかった';
    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        width: 50,
                        height: 3,
                        background: 'linear-gradient(90deg, rgba(109,40,217,0.6), rgba(139,92,246,0.4))',
                        borderRadius: 2,
                        marginTop: 2,
                    }} />
                </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div style={{
                                            ...
                                            borderRadius: '50%',
                                            backgroundColor: isCurrent ? '#6D28D9' : 'rgba(107,114,128,0.3)',
                                            boxShadow: isCurrent ? '0 0 8px rgba(109,40,217,0.5)' : 'none',
                                            flexShrink: 0,
                                        }} />
                                        <span style={{
                                            fontSize: isCurrent ? 15 : 13,
                                            fontWeight: isCurrent ? 800 : 500,
                                            color: isCurrent ? '#5B21B6' : '#6B7280',
                                            fontFamily: '"Zen Maru Gothic", sans-serif',
                                            lineHeight: 1.3,
                                            whiteSpace: 'nowrap',
                                            overflow: 'hidden',
                ...
                {currentSpeaker && (
                    <div style={{
                        ...
                        <div style={{
                            ...
                            height: 8,
                            borderRadius: '50%',
                            backgroundColor: currentEntry?.speakerColor ?? '#6D28D9',
                            boxShadow: `0 0 8px ${currentEntry?.speakerColor ?? '#6D28D9'}`,
                        }} />
                        <span style={{
                            fontSize: 15,
                            fontWeight: 800,
            ...
            >
                <OffthreadVideo
                    src={staticFile('videos/dopamine_not_pleasure.mp4')}
                    style={{
                        width: '100%',
                        height: '100%',
                        objectFit: 'cover',
