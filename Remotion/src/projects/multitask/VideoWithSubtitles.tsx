...
export const VideoWithSubtitles: React.FC = () => {
    ...
    const headerTitle = currentEntry?.sceneTitle ?? '「マルチタスク」って本当にできてるの？';
    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        width: 50,
                        height: 3,
                        background: 'linear-gradient(90deg, rgba(99,102,241,0.6), rgba(129,140,248,0.4))',
                        borderRadius: 2,
                        marginTop: 2,
                    }} />
                </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div style={{
                                            ...
                                            borderRadius: '50%',
                                            backgroundColor: isCurrent ? '#6366F1' : 'rgba(107,114,128,0.3)',
                ...
                {currentSpeaker && (
                    <div style={{
                        ...
                        <div style={{
                            ...
                            height: 8,
                            borderRadius: '50%',
                            backgroundColor: currentEntry?.speakerColor ?? '#6366F1',
                            boxShadow: `0 0 8px ${currentEntry?.speakerColor ?? '#6366F1'}`,
                        }} />
                        <span style={{
                            fontSize: 15,
                            fontWeight: 800,
            ...
            >
                <OffthreadVideo
                    src={staticFile('videos/multitask.mp4')}
                    style={{
                        width: '100%',
                        height: '100%',
                        objectFit: 'cover',
