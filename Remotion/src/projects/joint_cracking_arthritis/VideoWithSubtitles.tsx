...
export const VideoWithSubtitles: React.FC = () => {
    ...
    const headerTitle = currentEntry?.sceneTitle ?? '関節を鳴らすと関節炎になる？';
    ...
    return (
        <AbsoluteFill>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 28 }}>
                    ...
                    <div style={{
                        ...
                        background: 'linear-gradient(90deg, rgba(6,182,212,0.6), rgba(79,70,229,0.4))',
                    }} />
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 28 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <span style={{ fontSize: 14, fontWeight: 800, color: 'rgba(6,182,212,0.8)', fontFamily: '"Inter", sans-serif' }}>{progressPercent}%</span>
                    </div>
                    <div style={{ width: '100%', height: 4, backgroundColor: 'rgba(0,0,0,0.06)', borderRadius: 3, overflow: 'hidden' }}>
                        <div style={{ width: `${progressPercent}%`, height: '100%', background: 'linear-gradient(90deg, #06B6D4, #4F46E5)', borderRadius: 3 }} />
                    </div>
                </div>
                ...
                {currentSpeaker && (
                    <div style={{
                        ...
                        <div style={{
                            ...
                            backgroundColor: currentEntry?.speakerColor ?? '#06B6D4',
                            boxShadow: `0 0 8px ${currentEntry?.speakerColor ?? '#06B6D4'}`,
                        }} />
            ...
            >
                <OffthreadVideo
                    src={staticFile('videos/joint_cracking_arthritis.mp4')}
